...
# 20150623: used to create a 'libspatialite.so' with Android_4.3.0_so.mk
...
common_sqlite_flags := \
 ...
 -DSQLITE_ENABLE_LOAD_EXTENSIONS \
...
# 'libspatialite.so' specific setting
...
LOCAL_STATIC_LIBRARIES := iconv proj geos libxml2 sqlite
